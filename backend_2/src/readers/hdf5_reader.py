...
class HDF5Reader:
    ...
    def _get_local_path(self, key: str, bucket: Optional[str] = None) -> str:
        """Resolve object key to an absolute filesystem path."""
        return str(self.storage.resolve_object_path(key, bucket=bucket))
    ...
    def get_dataset_info(self, key: str, path: str, bucket: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            with self.storage.open_object_stream(key, bucket=bucket) as f:
    ...
    def get_children(self, key: str, path: str = '/', bucket: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        Args:
            ...
            bucket: Optional storage subfolder override
