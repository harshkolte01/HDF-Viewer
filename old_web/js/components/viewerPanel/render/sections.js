...
function renderVirtualLineShell(state, config, preview) {
  ...
  return `
    <div
      ...
      data-line-bucket="${escapeHtml(state.selectedFileBucket || "")}"
...
function renderVirtualMatrixShell(state, config) {
  ...
  return `
    <div
      ...
      data-matrix-bucket="${escapeHtml(state.selectedFileBucket || "")}"
...
function renderVirtualHeatmapShell(state, config) {
  return `
    <div
      ...
      data-heatmap-bucket="${escapeHtml(state.selectedFileBucket || "")}"
